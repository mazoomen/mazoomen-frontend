  ...
  return (
    <div id="rsvp-section" className="space-y-8" dir={isEn ? "ltr" : "rtl"}>
      ...
      <div className="text-center mb-8">
        <h3 className="text-base mb-4 tracking-wide text-[#8A4E35] font-semibold">{isEn ? "Bride & Groom Message" : "رسالة العروسين"}</h3>
        ...
        {canUpload && (
          <div className="flex justify-center mt-3">
            <label className="flex items-center gap-2 px-6 py-2.5 text-xs font-semibold rounded-full border border-black/15 shadow-xs backdrop-blur-md hover:bg-black/5 cursor-pointer bg-white/60 text-black">
              <Camera className="w-4 h-4 text-[#8A4E35]" />
      ...
      <div className="text-center py-6">
        ...
        <div className="text-4xl font-light mb-3 text-[#8A4E35]">219</div>
      ...
      >
        <h3 className="text-center text-xl mb-4 font-semibold text-black flex items-center justify-center gap-2">
          <Heart className="w-5 h-5 text-[#8A4E35] fill-[#8A4E35]" />
          ...
          <form onSubmit={handleRsvpSubmit} className={`space-y-4 ${isEn ? "text-left" : "text-right"}`}>
            ...
            <div>
              ...
              <input
                ...
                required
                className={`w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-white/60 focus:bg-white text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-[#8A4E35] ${isEn ? "text-left" : "text-right"}`}
              />
            </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`py-2.5 rounded-xl border font-semibold text-sm transition-all duration-300 cursor-pointer ${attendance === 'YES'
                      ? 'bg-[#8A4E35] text-white border-[#8A4E35]'
            ...
            {attendance === 'YES' && (
              <div className="animate-fade-in">
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-white/60 text-gray-800 focus:outline-none focus:ring-1 focus:ring-[#8A4E35]"
                >
            ...
            <div>
              ...
              <textarea
                ...
                className={`w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-white/60 focus:bg-white text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-[#8A4E35] resize-none ${isEn ? "text-left" : "text-right"}`}
              />
            </div>
            ...
            <button
              ...
              style={{ background: 'linear-gradient(135deg, #8A4E35, #A26B54)' }}
            >
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 overflow-y-auto px-2 wishes-scroll max-h-[420px]" style={{ scrollbarWidth: 'none' }}>
          {wishes.map((wish, index) => (
            ...
            >
              <p className="text-sm text-center leading-relaxed text-[#8A4E35] font-semibold mb-1">"{wish.text}"</p>
