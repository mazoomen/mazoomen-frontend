...
interface InvitationClientPageForestFoliageProps {
...
export default function InvitationClientPageForestFoliage({
  invitation: initialInvitation,
  slug,
  isDeactivatedInitial = false,
  viewingLangProp,
  setViewingLangProp
}: InvitationClientPageForestFoliageProps) {
  ...
  return (
    <main className="min-h-screen bg-[#E4E2D0] relative flex flex-col justify-center font-cairo forest-foliage-theme">
      ...
      <style dangerouslySetInnerHTML={{
        ...
        /* Override Global CSS definitions to match the forest foliage theme */
        .forest-foliage-theme .timeline-time, 
        .forest-foliage-theme .timeline-title {
        ...
        .forest-foliage-theme .timeline-time.active, 
        .forest-foliage-theme .timeline-title.active {
          color: #B89C72 !important;
          opacity: 1 !important;
          transform: translateY(0) !important;
        }

        /* Timeline Dot - Golden Accent theme */
        .forest-foliage-theme .timeline-dot {
          background: rgba(16, 48, 32, 0.2) !important;
        ...
        .forest-foliage-theme .timeline-dot.active {
          background: #B89C72 !important;
          transform: scale(1.4) !important;
          box-shadow: 0 0 0 4px rgba(184, 156, 114, 0.15), 0 0 14px 6px rgba(184, 156, 114, 0.2) !important;
        }

        /* Details list items custom dots overrides */
        .forest-foliage-theme .timeline-detail-dot {
          transform: scale(0.6) !important;
          background: rgba(16, 48, 32, 0.15) !important;
          box-shadow: none !important;
          transition: background 0.6s, box-shadow 0.6s, transform 0.6s cubic-bezier(0.16, 1, 0.3, 1) !important;
        }

        .forest-foliage-theme .detail-item-row.visible .timeline-detail-dot {
          transform: scale(1.2) !important;
          background: #103020 !important;
          box-shadow: 0 0 0 4px rgba(16, 48, 32, 0.1), 0 0 14px 6px rgba(16, 48, 32, 0.15) !important;
        }

        /* General override for details cards slide-in transitions */
        .forest-foliage-theme .detail-item-row .rounded-xl {
          opacity: 0 !important;
          transform: translateX(20px) !important;
          transition: opacity 0.8s cubic-bezier(0.16, 1, 0.3, 1), transform 0.8s cubic-bezier(0.16, 1, 0.3, 1) !important;
        }
        
        .forest-foliage-theme .detail-item-row.visible .rounded-xl {
          opacity: 1 !important;
        ...
        {particles.map((p) => (
          <div
            ...
            style={{
              ...
              width: `${p.size}px`,
              height: `${p.size}px`,
              backgroundColor: 'rgba(233, 211, 176, 0.85)',
              borderRadius: '50%',
              boxShadow: '0 0 6px rgba(184, 156, 114, 0.95), 0 0 12px rgba(233, 211, 176, 0.5)',
      ...
      <div className="relative w-full max-w-md md:max-w-xl lg:max-w-2xl mx-auto overflow-hidden bg-[#FAF9F5] border border-[#E4E2D0]/50 shadow-2xl rounded-none md:rounded-[32px] md:my-8 animate-on-scroll" dir={isEn ? "ltr" : "rtl"} style={{ color: '#103020' }}>
        ...
        <section className="relative min-h-[700px] flex flex-col items-center justify-start text-center pt-24">
          ...
          <div className="relative z-10 -mt-8 pr-6 pl-6 flex flex-col items-center w-full">
            ...
            <div className="text-sm tracking-[0.25em] mb-4 text-[#B89C72] font-bold">{isEn ? "Wedding Invitation" : "حفل زفاف"}</div>

            {/* Calligraphic Decorative Large Names */}
            <h1 className="font-aref font-bold leading-none text-[#103020] select-none my-3 tracking-wide">
              {groom}
            </h1>
            {bride && (
              <>
                <span className="text-3xl font-aref font-normal text-[#B89C72] my-1">&amp;</span>
            ...
            <div className="mt-10">
              <div className="text-xs font-bold tracking-wide bg-[#FAF9F5]/85 backdrop-blur-xs px-5 py-2.5 rounded-full border border-[#B89C72]/30 text-[#103020] shadow-xs">
                {getFormattedDate()}
              </div>
            </div>
          </div>
          <div className="absolute bottom-16 left-10 right-10 h-px bg-[#B89C72]/20" />
        </section>
        ...
        <section className="relative min-h-[700px] py-12 px-6 flex flex-col justify-center">
          <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
            <video
              ...
              style={{ objectPosition: 'center center', transform: 'scale(1.02)' }}
            />
            <div className="absolute inset-0 bg-[#FAF9F5]/35" />
          </div>
          ...
          <div className="relative z-10 space-y-8 w-full max-w-lg mx-auto">
            ...
            <div
              ...
              style={{
                ...
                boxShadow: '0 8px 32px 0 rgba(16, 48, 32, 0.06)',
                borderRadius: '28px'
              }}
            >
              <div className="text-center">
                <div className="flex justify-center mb-2">
                  <span className="text-3xl text-[#B89C72]">🌿</span>
                </div>
                <h4 className="text-xs font-bold tracking-widest text-[#B89C72] mb-4 uppercase">{isEn ? "Wedding Invitation" : "دعوة لحضور حفل زفاف"}</h4>
                <div className="text-[15px] whitespace-pre-line text-[#103020] leading-relaxed mb-6 font-medium">
                  {welcomeText || defaultWelcomeText}
                </div>
                <div className="text-xl font-amiri font-bold text-[#103020] tracking-wide">
                  {groom} {bride ? `& ${bride}` : ''}
                </div>
              </div>
            </div>
            ...
            <div className="text-center animate-on-scroll fade-up">
              <span className="text-xs tracking-widest uppercase text-[#B89C72] font-bold block mb-1">{isEn ? "LOCATION" : "الموقع"}</span>
              <h3 className="font-bold text-lg text-[#103020]">{hallName?.trim()}</h3>
              {cityName && <p className="text-sm text-[#B89C72]/80 mt-1 font-semibold">{cityName?.trim()}</p>}
            </div>

            {/* Elegant Calendar Widget */}
            <div className="animate-on-scroll fade-up flex justify-center" style={{ perspective: '1200px' }}>
              <div className="w-full max-w-[240px] overflow-hidden shadow-md border border-[#B89C72]/30" style={{ borderRadius: '22px' }}>
                <div className="relative flex items-center justify-between px-5 py-3 bg-[#103020]">
                ...
                <div className="flex flex-col items-center py-5 px-4 bg-[#FAF9F5]/80 backdrop-blur-md">
                  <span className="font-bold leading-none text-[5rem] text-[#103020] font-amiri">{getDayNum()}</span>
                  <div className="w-10 h-px my-3 bg-[#B89C72]/30" />
                  <span className="text-[11px] tracking-[0.25em] uppercase mb-1 text-[#B89C72] font-semibold">{getDayName()}</span>
                  <span className="text-sm font-bold tracking-widest text-[#103020]">{getTimeString()}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center animate-on-scroll fade-up">
              <button
                ...
                className="flex items-center gap-2 px-6 py-2.5 text-xs font-semibold rounded-full border border-[#B89C72]/35 shadow-sm backdrop-blur-md hover:bg-[#FAF9F5] transition-all text-[#103020] bg-white/80 cursor-pointer"
              >
            ...
            >
              <h4 className="text-center text-xs tracking-widest font-bold text-[#B89C72] mb-3">{isEn ? "COUNTDOWN" : "العد التنازلي للمناسبة"}</h4>
              <div className="grid grid-cols-4 gap-2">
                {[
                  ...
                  <div key={idx} className="text-center p-2 rounded-xl bg-white border border-slate-100 shadow-xs">
                    <div className="text-xl font-bold text-[#103020]">
                      {item.val}
                    </div>
                    <div className="text-[9px] tracking-wider mt-1 text-[#B89C72] font-semibold">{item.label}</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          <section className="relative min-h-[700px] py-12 px-6 flex flex-col justify-center">
            ...
            <div className="relative z-10 w-full max-w-lg mx-auto space-y-12">
              ...
              <div ref={timelineContainerRef} className="relative py-8 pl-8 pr-4">
                <h3 className="text-center text-sm font-bold tracking-widest uppercase mb-12 text-[#103020]">
                ...
                <div className="absolute top-24 bottom-12 left-4 w-[2px] bg-slate-200">
                  <div
                    ...
                    className="absolute top-0 w-full bg-[#B89C72] transition-all duration-300 ease-out"
              ...
              {detailRules.length > 0 && (
                <div ref={detailsContainerRef} className="space-y-6 pt-6">
                  <h3 className="text-center text-sm font-bold tracking-widest uppercase mb-6 text-[#103020]">
        ...
        <section className="relative min-h-[763px] py-12 px-6 flex flex-col justify-center">
          ...
          <div className="relative z-10 w-full max-w-lg mx-auto space-y-12">
            ...
            >
              <h4 className="text-center text-xs tracking-widest font-bold text-[#B89C72] mb-6 uppercase">{isEn ? "CONFIRM ATTENDANCE" : "تأكيد الحضور"}</h4>
              ...
              {status === 'success' ? (
                ...
                <form onSubmit={handleRsvpSubmit} className="space-y-5">
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-[#103020]/75">{isEn ? "Full Name" : "الاسم الكامل"}</label>
                    <input
                      type="text"
                      required
                      ...
                      className="w-full px-4 py-3 rounded-xl border text-xs font-semibold focus:outline-hidden transition-all"
                      style={{
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-[#103020]/75">{isEn ? "Will You Attend?" : "هل ستشرفنا بالحضور؟"}</label>
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        type="button"
                        onClick={() => {
                        ...
                        style={
                          attendance === 'YES'
                            ? { backgroundColor: '#103020', borderColor: '#103020', color: '#ffffff' }
                            : { backgroundColor: 'rgba(255, 255, 255, 0.6)', borderColor: 'rgba(184, 156, 114, 0.3)', color: 'rgba(16, 48, 32, 0.7)' }
                        }
                      >
                      ...
                      <button
                        ...
                        className={`py-3 rounded-xl text-xs font-bold border transition-all cursor-pointer ${
                          attendance === 'NO' ? 'shadow-md' : 'hover:bg-[#FAF9F5]/50'
                        }`}
                        style={
                          attendance === 'NO'
                            ? { backgroundColor: '#103020', borderColor: '#103020', color: '#ffffff' }
                  ...
                  {invitation.allowCompanions !== false && attendance === 'YES' && (
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div
                          className="flex-grow text-center py-2.5 rounded-lg border text-xs font-bold"
                          style={{
                            borderColor: 'rgba(184, 156, 114, 0.2)',
                  ...
                  <button
                    ...
                    className="w-full py-3.5 rounded-xl text-xs font-bold shadow-md hover:shadow-lg transition-all cursor-pointer"
                    style={{
                      backgroundColor: status === 'submitting' ? '#cbd5e1' : '#103020',
                      color: '#ffffff',
              ...
              >
                ...
                <div className="max-h-[300px] overflow-y-auto pr-2 space-y-4">
                  {wishes.map((wish, idx) => (
                    <div
                      key={idx}
                      className="p-4 bg-[#FAF9F5]/70 rounded-xl border border-[#B89C72]/20 shadow-xs flex flex-col gap-1 text-left"
                    >
        ...
        <section className="relative min-h-[302px] py-12 px-6 flex flex-col justify-center text-center">
          <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
            <video
              ...
              style={{ objectPosition: 'center center', transform: 'scale(1.02)' }}
            />
            <div className="absolute inset-0 bg-[#FAF9F5]/45" />
          </div>

          <div className="relative z-10 flex flex-col items-center">
            <div className="w-16 h-px mb-5 bg-slate-200" />
            <h5 className="text-base text-[#103020] font-amiri font-bold mb-1">{eventTitle}</h5>
            <p className="text-xs text-[#B89C72] font-semibold mb-4">
