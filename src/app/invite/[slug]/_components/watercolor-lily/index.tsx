...
export default function InvitationClientPageWatercolorLily({
  ...
  return (
    <main className="min-h-screen bg-[#FAF5FA] relative flex flex-col justify-center font-cairo garden-theme">
      ...
      <EnvelopeOverlay eventTitle={eventTitle} onOpen={handleOpenInvitation} sealImage="/images/lavender-seal.png" viewingLang={isEn ? "en" : "ar"} customSealStyle={{ transform: 'scale(1.45)' }} />
