...
interface InvitationClientPageWatercolorLilyProps {
...
export default function InvitationClientPageWatercolorLily({
  invitation: initialInvitation,
  slug,
  isDeactivatedInitial = false,
  viewingLangProp,
  setViewingLangProp
}: InvitationClientPageWatercolorLilyProps) {
  ...
  const detailRules = (invitation.eventDetails || []).map((d: any) => ({
    icon: <Info className="w-4.5 h-4.5 text-[#96608D]" />,
    text: isEn ? (d.textEn || d.text || "") : (d.textAr || d.text || ""),
  }));

  return (
    <main className="min-h-screen bg-[#FAF5FA] relative flex flex-col justify-center font-cairo garden-theme">
      ...
      <style dangerouslySetInnerHTML={{
        ...
        .font-aref {
          ...
          text-shadow: 1px 1px 3px rgba(150, 96, 141, 0.12) !important;
        }
        ...
        .garden-theme .timeline-dot {
          background: rgba(150, 96, 141, 0.25) !important;
        ...
        .garden-theme .timeline-dot.active {
          background: #96608D !important;
          transform: scale(1.4) !important;
          box-shadow: 0 0 0 4px rgba(150, 96, 141, 0.15), 0 0 14px 6px rgba(150, 96, 141, 0.25) !important;
        }

        /* Details list items custom dots overrides - clean circle like template 1 */
        .garden-theme .timeline-detail-dot {
          transform: scale(0.6) !important;
          background: rgba(150, 96, 141, 0.2) !important;
          box-shadow: none !important;
      ...
      {invitation.languageMode === "both" && setViewingLangProp && (
        <button
          ...
          style={{
            background: 'rgba(253, 248, 253, 0.55)',
            borderColor: 'rgba(150, 96, 141, 0.35)',
            color: '#96608D',
            boxShadow: 'rgba(150, 96, 141, 0.15) 0px 4px 20px',
          }}
        >
          {isEn ? 'AR' : 'EN'}
        </button>
      ...
      <EnvelopeOverlay eventTitle={eventTitle} onOpen={handleOpenInvitation} sealImage="/images/lavender-seal.png" viewingLang={isEn ? "en" : "ar"} customSealStyle={{ transform: 'translate(0px, -1px) scale(1.60)' }} />
      ...
      <div className="relative w-full max-w-md md:max-w-xl lg:max-w-2xl mx-auto overflow-hidden bg-white shadow-2xl rounded-none md:rounded-[32px] md:my-8 animate-on-scroll" dir={isEn ? "ltr" : "rtl"} style={{ color: '#4A2E4B' }}>
        ...
        <section className="relative min-h-[700px] flex flex-col items-center justify-start text-center pt-24">
          <div className="absolute inset-0 z-0 overflow-hidden">
            ...
            />
            {/* Soft tint overlay */}
            <div className="absolute inset-0 bg-[#FAF5FA]/20" />
          </div>
          <div className="relative z-10 -mt-8 pr-6 pl-6 flex flex-col items-center w-full">
            <div className="mx-auto mb-8 h-px w-24 bg-gradient-to-r from-transparent via-[#4A2E4B]/40 to-transparent" />
            <div className="text-base tracking-[0.25em] mb-4 text-[#4A2E4B] font-semibold">{isEn ? "Wedding Invitation" : "حفل زفاف"}</div>

            {/* Calligraphic Decorative Large Names */}
            <h1 className="font-aref font-bold leading-none text-[#4A2E4B] select-none my-3 tracking-wide">
              {groom}
            </h1>
            {bride && (
              <>
                <span className="text-3xl font-aref font-normal text-[#96608D] my-1">&amp;</span>
                <h1 className="font-aref font-bold leading-none text-[#4A2E4B] select-none my-3 tracking-wide">
                  {bride}
                </h1>
              </>
            ...
            <div className="mt-10">
              <div className="text-xs font-bold tracking-wide bg-[#FAF5FA]/60 backdrop-blur-xs px-5 py-2.5 rounded-full border border-[#4A2E4B]/10 text-[#4A2E4B]">
                {getFormattedDate()}
              </div>
            </div>
          </div>
          <div className="absolute bottom-16 left-10 right-10 h-px bg-[#4A2E4B]/10" />
        </section>
        ...
        <section className="relative min-h-[700px] py-12 px-6 flex flex-col justify-center">
          <div className="absolute inset-0 z-0 overflow-hidden">
            <video
              ...
              style={{ objectPosition: 'center center', transform: 'scale(1.02)' }}
            />
            <div className="absolute inset-0 bg-[#FAF5FA]/30" />
          </div>
          ...
          <div className="relative z-10 space-y-8 w-full max-w-lg mx-auto">
            ...
            <div
              ...
              style={{
                ...
                background: 'rgba(253, 248, 253, 0.65)',
                border: '1px solid rgba(255, 255, 255, 0.45)',
                boxShadow: '0 8px 32px 0 rgba(74, 46, 75, 0.06)',
                borderRadius: '28px'
              }}
            >
              <div className="text-center">
                <div className="flex justify-center mb-2">
                  <span className="text-3xl text-[#96608D]">🌸</span>
                </div>
                <h4 className="text-sm font-bold tracking-widest text-[#4A2E4B] mb-4 uppercase">{isEn ? "Wedding Invitation" : "دعوة لحضور حفل زفاف"}</h4>
                <div className="text-[15px] whitespace-pre-line text-[#4A2E4B] leading-relaxed mb-6 font-medium">
                  {welcomeText || defaultWelcomeText}
                </div>
                <div className="text-xl font-amiri font-bold text-[#96608D] tracking-wide">
                  {groom} {bride ? `& ${bride}` : ''}
                </div>
              </div>
            </div>
            ...
            <div className="text-center animate-on-scroll fade-up">
              <span className="text-xs tracking-widest uppercase text-[#4A2E4B]/60 font-bold block mb-1">{isEn ? "LOCATION" : "الموقع"}</span>
              <h3 className="font-bold text-lg text-[#4A2E4B]">{hallName?.trim()}</h3>
              {cityName && <p className="text-sm text-[#4A2E4B]/80 mt-1 font-semibold">{cityName?.trim()}</p>}
            </div>

            {/* Elegant Calendar Widget */}
            <div className="animate-on-scroll fade-up flex justify-center" style={{ perspective: '1200px' }}>
              <div className="w-full max-w-[240px] overflow-hidden shadow-md border border-[#4A2E4B]/10" style={{ borderRadius: '22px' }}>
                <div className="relative flex items-center justify-between px-5 py-3 bg-[#4A2E4B]">
                ...
                <div className="flex flex-col items-center py-5 px-4 bg-white/60 backdrop-blur-md">
                  <span className="font-bold leading-none text-[5rem] text-[#4A2E4B] font-amiri">{getDayNum()}</span>
                  <div className="w-10 h-px my-3 bg-[#4A2E4B]/10" />
                  <span className="text-[11px] tracking-[0.25em] uppercase mb-1 text-[#4A2E4B] font-semibold">{getDayName()}</span>
                  <span className="text-sm font-bold tracking-widest text-[#96608D]">{getTimeString()}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center animate-on-scroll fade-up">
              <button
                ...
                className="flex items-center gap-2 px-6 py-2.5 text-xs font-semibold rounded-full border border-white/40 shadow-xs backdrop-blur-md hover:bg-white/35 transition-all text-[#4A2E4B] bg-[#FAF5FA]/60 cursor-pointer"
              >
                <Calendar className="w-4.5 h-4.5 text-[#96608D]" />
            ...
            >
              <h4 className="text-center text-xs tracking-widest font-bold text-[#4A2E4B] mb-3">{isEn ? "COUNTDOWN" : "العد التنازلي للمناسبة"}</h4>
              <div className="grid grid-cols-4 gap-2">
                {[
                  ...
                  <div key={idx} className="text-center p-2 rounded-xl bg-white/50 border border-[#4A2E4B]/10 shadow-xs">
                    <div className="text-xl font-bold text-[#4A2E4B]">
                      {item.val}
                    </div>
                    <div className="text-[9px] tracking-wider mt-1 text-[#4A2E4B]/70 font-semibold">{item.label}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="relative min-h-[700px] py-12 px-6 flex flex-col justify-center">
          ...
          <div className="relative z-10 w-full max-w-lg mx-auto space-y-8">
            ...
            {timelineEvents.length > 0 && (
              ...
              >
                <h3 className="text-center text-lg font-bold text-[#4A2E4B] mb-8">{isEn ? "Event Program" : "برنامج الحفل"}</h3>
                <div className="relative">
                  {/* Vertical Center Track Line */}
                  <div className="absolute top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-[#96608D]/30 to-transparent" style={{ left: '50%', transform: 'translateX(-50%)' }} />
                  ...
                  >
                    <div className="w-5 h-5 rounded-full" style={{ background: 'transparent', border: '2px solid #96608D', boxShadow: '0 0 0 4px rgba(150, 96, 141, 0.15), 0 0 18px 8px rgba(150, 96, 141, 0.25), 0 0 36px 16px rgba(150, 96, 141, 0.1)' }} />
                  </div>
            ...
            {detailRules.length > 0 && (
              ...
              >
                <h3 className="text-center text-lg font-bold text-[#4A2E4B] mb-5">{isEn ? "Event Guidelines" : "تفاصيل تهمك"}</h3>
                <div className={`space-y-4 relative ${isEn ? "pr-7" : "pl-7"}`}>
                  {/* Vertical track line for details rules */}
                  <div
                    className={`absolute ${isEn ? "right-2.5" : "left-2.5"} top-3.5 bottom-3.5 w-px bg-gradient-to-b from-transparent via-[#96608D]/30 to-transparent`}
                  />
                  ...
                  {detailRules.map((rule, idx) => (
                    <div key={idx} className="relative flex items-center gap-3.5 min-h-[52px] detail-item-row">
                      ...
                      <div className="flex items-center gap-3 flex-1 p-3 bg-white/40 border border-[#4A2E4B]/5 rounded-xl">
                        <span className="w-7 h-7 rounded-full bg-[#96608D]/10 border border-[#96608D]/10 flex items-center justify-center shrink-0">
                          {rule.icon}
                        </span>
                        <span className={`text-xs text-[#4A2E4B] font-semibold leading-tight w-full ${isEn ? "text-left" : "text-right"}`}>{rule.text}</span>
                      </div>
                    </div>
                  ))}
                </div>
        ...
        <section id="moments-section" className="relative min-h-[400px] py-12 px-6 flex flex-col justify-center">
          <div className="absolute inset-0 z-0 overflow-hidden">
            <video
              ...
              style={{ objectPosition: 'center center', transform: 'scale(1.02)' }}
            />
            <div className="absolute inset-0 bg-[#FAF5FA]/35" />
          </div>

          <div className="relative z-10 w-full max-w-lg mx-auto space-y-6">
            <h3 className="text-center text-lg font-bold text-[#4A2E4B] font-sans">{isEn ? "Moments from the wedding" : "لحظات من الحفل"}</h3>
            ...
            {invitation.moments && invitation.moments.length > 0 ? (
              ...
              <div className="text-center py-8 text-[#4A2E4B]/60 border border-dashed border-[#4A2E4B]/20 rounded-[22px] font-sans text-xs bg-white/30 backdrop-blur-md">
                {isEn ? "No moments captured yet. Be the first!" : "لا توجد صور ملتقطة بعد. كن أول من يشاركنا لحظاته!"}
              </div>
            )}

            {/* Camera Upload trigger for moments in Lavender theme */}
            {invitation.allowGuestUploads !== false && (
              <div className="flex justify-center mt-4">
                <label className="flex items-center gap-2 px-6 py-2.5 text-xs font-semibold rounded-full border border-[#4A2E4B]/15 shadow-xs backdrop-blur-md hover:bg-[#4A2E4B]/5 cursor-pointer bg-white/60 text-[#4A2E4B]">
                  <Camera className="w-4 h-4 text-[#96608D]" />
        ...
        <section id="rsvp-section" className="relative min-h-[763px] py-12 px-6 flex flex-col justify-center">
          ...
          <div className="relative z-10 w-full max-w-lg mx-auto space-y-8">
            ...
            <div className="text-center animate-on-scroll">
              <span className="text-xs tracking-widest uppercase text-[#4A2E4B]/60 font-bold block mb-1">{isEn ? "Bride & Groom Message" : "رسالة العروسين"}</span>
              <p className="text-[15px] text-[#4A2E4B] leading-relaxed whitespace-pre-line px-4 font-medium">
                {isEn
              ...
              <p className="text-sm font-bold text-[#96608D] mt-3">
            ...
            >
              <h3 className="text-center text-lg font-bold text-[#4A2E4B] mb-6 flex items-center justify-center gap-2">
                <Heart className="w-5 h-5 text-[#96608D] fill-[#96608D]" />
              ...
              {status === 'success' ? (
                <div className="text-center py-8 space-y-4">
                  ...
                  <button
                    ...
                    className="mt-4 px-6 py-2 text-xs font-semibold rounded-full border border-[#4A2E4B]/15 hover:bg-[#4A2E4B]/5 text-[#4A2E4B] cursor-pointer font-cairo"
                  >
                ...
                <form onSubmit={handleRsvpSubmit} className={`space-y-4 ${isEn ? "text-left" : "text-right"}`}>
                  {/* Guest Name */}
                  <div>
                    <label htmlFor="guest-name" className="block text-xs font-semibold text-[#4A2E4B] mb-1">{isEn ? "Your Full Name" : "الاسم الكريم"}</label>
                    <input
                      id="guest-name"
                      type="text"
                      value={guestName}
                      ...
                      required
                      className={`w-full px-4 py-2.5 rounded-xl border border-[#4A2E4B]/15 bg-white/70 focus:bg-white text-[#4A2E4B] placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-[#96608D] text-xs ${isEn ? "text-left" : "text-right"}`}
                    />
                  </div>

                  {/* Attendance */}
                  <div>
                    <label className="block text-xs font-semibold text-[#4A2E4B] mb-1">{isEn ? "Will you honor us with your presence?" : "هل ستشرفنا بحضورك؟"}</label>
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        type="button"
                  ...
                  {/* Message */}
                  <div>
                    <label htmlFor="wish-text" className="block text-xs font-semibold text-[#4A2E4B] mb-1">{isEn ? "Special message to the newlyweds (Optional)" : "تهنئة خاصة للعروسين (اختياري)"}</label>
                    <textarea
                      id="wish-text"
                      rows={2}
                      value={newWish}
                      ...
                      className={`w-full px-4 py-2.5 rounded-xl border border-[#4A2E4B]/15 bg-white/70 focus:bg-white text-[#4A2E4B] placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-[#96608D] resize-none text-xs ${isEn ? "text-left" : "text-right"}`}
                    />
                  </div>
                  ...
                  <button
                    ...
                    style={{ background: 'linear-gradient(135deg, #4A2E4B, #6E4D68)' }}
                  >
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 justify-center mb-2">
                <MessageCircle className="w-3.5 h-3.5 text-[#4A2E4B]/80" />
                <p className="text-xs tracking-wider uppercase text-[#4A2E4B]/80 font-bold">{isEn ? "Guests wishes & congratulations" : "تبريكات وتهاني المهنئين"}</p>
              </div>
                ...
                {wishes.map((wish, index) => (
                  <div
                    ...
                    style={{
                      ...
                      border: '1px solid rgba(255, 255, 255, 0.45)',
                      borderRadius: '20px',
                      boxShadow: '0 4px 16px 0 rgba(74, 46, 75, 0.03)'
                    }}
                  >
                    <p className="text-xs text-center leading-relaxed text-[#4A2E4B] font-semibold mb-1">"{wish.text}"</p>
                    <p className="text-[9px] text-center text-[#96608D] font-bold">— {wish.name}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="relative min-h-[302px] py-12 px-6 flex flex-col justify-center text-center">
          <div className="absolute inset-0 z-0 overflow-hidden">
            <video
              ...
              style={{ objectPosition: 'center center', transform: 'scale(1.02)' }}
            />
            <div className="absolute inset-0 bg-[#FAF5FA]/40" />
          </div>

          <div className="relative z-10 flex flex-col items-center">
            <div className="w-16 h-px mb-5 bg-[#4A2E4B]/10" />
            <h5 className="text-base text-[#4A2E4B] font-amiri font-bold mb-1">{eventTitle}</h5>
            <p className="text-xs text-[#96608D] font-semibold mb-4">
              {new Date(invitation.eventDate).toLocaleDateString(isEn ? 'en-US' : 'ar-EG', { day: 'numeric', month: 'long', year: 'numeric' })}
            </p>
            <a href="/" className="text-[9px] uppercase tracking-[0.25em] text-[#4A2E4B]/50 font-bold hover:underline transition-all cursor-pointer block">
        ...
        {showContactModal && (
          <div className="fixed inset-0 bg-[#2D3142]/40 backdrop-blur-sm z-[1000] flex items-center justify-center p-4">
            <div
              className="bg-[#FAF8F5] border border-[#96608D]/15 rounded-[28px] max-w-sm w-full p-6 shadow-2xl relative text-center"
              dir={isEn ? "ltr" : "rtl"}
            >
              {/* Close Button */}
              <button
              ...
              <h3 className="text-lg font-bold text-[#4A2E4B] mb-1 font-sans">
                {invitation.contactName || (isEn ? "WhatsApp Contact" : "للتواصل والاستفسار")}
              </h3>
              <p className="text-sm text-[#96608D] font-semibold mb-6 font-sans">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <Phone className="w-4 h-4 text-[#96608D]" />
                  {isEn ? "Call" : "اتصال"}
                </a>
                <a
