        ...
        {events.map((event, index) => (
          ...
          >
            <div className="w-[calc(50%-14px)] flex items-center justify-end pr-6">
              <span className="text-sm font-bold text-right timeline-time" style={{ color: 'rgb(172, 140, 96)' }}>
                {event.time}
              </span>
            </div>
            ...
            <div className="w-[calc(50%-14px)] flex items-center justify-start pl-6">
              <span className="text-sm font-bold text-left timeline-title" style={{ color: 'rgb(172, 140, 96)' }}>
                {event.title}
              </span>
            </div>
          </div>
