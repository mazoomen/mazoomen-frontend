...
// Separated from LanguageContext to keep data and logic apart.
// Add new translations here, organized by feature section.
...
export const translations: Record<string, Record<Language, string>> = {
  ...
  "or": { en: "or", ar: "أو" },
  "Google Sign-In failed. Please try again.": { en: "Google Sign-In failed. Please try again.", ar: "فشل تسجيل الدخول بحساب Google. يرجى المحاولة مرة أخرى." },
  ...
  "OTP Verification": { en: "OTP Verification", ar: "رمز التحقق" },
  "Send Code": { en: "Send Verification Code", ar: "إرسال رمز التحقق" },
  "Sending Code...": { en: "Sending Code...", ar: "جاري إرسال الرمز..." },
  "Verify & Complete Registration": { en: "Verify & Complete Registration", ar: "تأكيد وإنشاء الحساب" },
  "Resend Code": { en: "Resend Code", ar: "إعادة إرسال الرمز" },
  "Edit Info": { en: "Edit Details", ar: "تعديل البيانات" },
  "Code sent! Please check your email inbox.": { en: "Code sent! Please check your email inbox.", ar: "تم إرسال الرمز! يرجى التحقق من بريدك الإلكتروني." },
  "Change Password": { en: "Change Password", ar: "تغيير كلمة المرور" },
  "Verify & Change Password": { en: "Verify & Change Password", ar: "تأكيد وتغيير كلمة المرور" },
  ...
  "Enter your registered email address to receive a verification code.": { en: "Enter your registered email address to receive a verification code.", ar: "أدخل بريدك الإلكتروني المسجل لاستلام رمز التحقق." },
  "Send Reset Code": { en: "Send Reset Code", ar: "إرسال رمز إعادة التعيين" },
  "Back to Login": { en: "Back to Login", ar: "العودة لتسجيل الدخول" },
  "Password reset successfully. Please log in with your new password.": { en: "Password reset successfully. Please log in with your new password.", ar: "تم إعادة تعيين كلمة المرور بنجاح. يرجى تسجيل الدخول بكلمة المرور الجديدة." },
  "errors.user_not_found": { en: "No account found with this email address.", ar: "لا يوجد حساب مرتبط بهذا البريد الإلكتروني." },
  ...
  "Pay & Unlock": { en: "Pay & Unlock", ar: "الدفع السريع والتفعيل" },
  "Pay securely online using KNET, Mada, Credit Card, or Apple Pay to immediately activate your template.": {
    en: "Pay securely online using KNET, Mada, Credit Card, or Apple Pay to immediately activate your template.",
    ar: "ادفع بأمان عبر KNET، مدى، البطاقات الائتمانية، أو Apple Pay لفتح وتفعيل قالبك فوراً.",
  },
  ...
  "Share Invitation": { en: "Share Invitation", ar: "مشاركة الدعوة" },
  "Share on Phone": { en: "Share on Phone", ar: "المشاركة عبر الهاتف" },
  "Download QR Code": { en: "Download QR Code", ar: "تحميل رمز QR" },
  "Scan QR Code to view invitation": { en: "Scan QR Code to view invitation", ar: "امسح رمز QR لمشاهدة الدعوة" },
  ...
  "Are you sure you want to delete this image?": { en: "Are you sure you want to delete this image?", ar: "هل أنت متأكد من رغبتك في حذف هذه الصورة؟" },
  ...
  "RSVP Details": { en: "RSVP Details", ar: "تفاصيل الرد" },
  "Guest Name": { en: "Guest Name", ar: "اسم الضيف" },
  "Companions": { en: "Companions", ar: "المرافقين" },
  "Number of Companions": { en: "Number of Companions", ar: "عدد المرافقين" },
